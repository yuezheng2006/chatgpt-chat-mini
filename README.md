...
> 本项目参考 [chatgpt-demo](https://github.com/ddiu8081/chatgpt-demo) 开发。
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/yuezheng2006/chatgpt-vercel&env=OPENAI_API_KEY)
...
| `DEFAULT_MESSAGE`                  | 默认提示信息                                                 | - 由 [OpenAI API (gpt-3.5-turbo)](https://platform.openai.com/docs/guides/chat) 和 [Vercel](http://vercel.com/) 提供支持。<br/>- [[Shift]] + [[Enter]] 换行。开头输入 [[/]] 或者 [[空格]] 搜索 Prompt 预设。点击输入框滚动到底部。 |
...
| `RESET_CONTINUOUS_DIALOGUE_OPTION` | 刷新时重置 `开启连续对话` 选项，在分享给很多人用的时候可以有效避免大量消耗。 | true                                                        |
| `OPENAI_API_BASE_URL`              | 本地开发时可以填写 OpenAI 的代理服务器，但是使用 Vercel 不需要。 | api.openai.com                                               |
| `PASSWORD`                         | 网站访问密码                                                     | 无                                                           |
